 ...
 */
function validateCode(code, campaign = 'rubbellos_2025') {
  // Input-Validierung
...
function markCodeAsUsed(code, email, additionalData = {}) {
  try {
    ...
    db[normalizedCode] = {
      ...
      campaign: additionalData.campaign || 'rubbellos_2025',
      website: additionalData.website || 'rubbellos.sweetsausallerwelt.de',
